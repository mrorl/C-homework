...
computer_strategy_2::computer_strategy_2(std::string name) :
        name(std::move(name)) {}

step_t computer_strategy_2::make_step(const field_t &fld) {
...
void computer_strategy_2::print_stat() const {
